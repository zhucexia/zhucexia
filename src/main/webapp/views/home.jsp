...
<script src="${root }/static/js/common/jquery-1.10.2.min.js"></script>
<script src="${root }/static/js/plugins/jquery-ui-1.10.3.min.js"></script>
<script src="${root }/static/js/plugins/jquery.ui.datepicker-zh-CN.js"></script>
<link rel="stylesheet" href="${root }/static/css/plugins/jquery-ui.min.css">
<script src="${root }/static/js/plugins/bootstrap-alert.js"></script>
<script src="${root }/static/js/plugins/bootstrap-dropdown.js"></script>
</head>
<body class="medium">
	<div class="WB_miniblog">
		<div class="topNavWrap-pindao" style="background-color:">
			<div class="grhead">
				<div class="grlogo ll">
					<a target="_blank" href="http://www.zhucexia.com/"><img
						src="${root }/static/images/header/logo.png"
						style="height: 48px; vertical-align: top;"></a>
				</div>
				<div class="grinfo">
					<div class="site-nav">
						<ul class="site-nav-bd-r">
							...
							<li class="dark user-menu" style="margin-left: 5px;">
								<a title="首页" target="_blank" class="s1" href="http://www.zhucexia.com/">网站首页</a> | 
								<a title="关于我们" target="_blank" rel="nofollow" href="http://www.zhucexia.com/about.html">关于我们</a> | 
								<a title="产品中心" target="_blank" rel="nofollow" href="http://www.zhucexia.com/product.html">产品中心</a> | 
								<a title="联系方式" target="_blank" rel="nofollow" href="http://www.zhucexia.com/contact.html">联系方式</a> | 
								<a href="#">tester</a><a href="http://www.zhucexia.com/account/logout/">退出</a>
							</li>
						</ul>
					</div>
				</div>
		...
		<div class="second_newmenu">
			<div class="navboxSecond">
				<div class="subNav" id="widget-subnav">
					<span class="clt"></span><span class="crt"></span><span class="clb"></span><span
						class="crb"></span>
					<div class="navLt wisub" style="display: none;">
						<a title="首页" target="_blank" class="s1"
							href="http://www.zhucexia.com/">网站首页</a> | <a title="关于我们"
							target="_blank" rel="nofollow"
							href="http://www.zhucexia.com/about.html">关于我们</a> | <a
							title="产品中心" target="_blank" rel="nofollow"
							href="http://www.zhucexia.com/product.html">产品中心</a> | <a
							title="联系方式" target="_blank" rel="nofollow"
							href="http://www.zhucexia.com/contact.html">联系方式</a>
					</div>
					<div class="navRt wisub">
						<a href="${root }/static/助策侠网络科技有限公司 我的账户.html" class="selected">
							我的账户 </a> | <a href="http://www.zhucexia.com/formdata/"> 我的预约 </a> |



						<a href="http://www.zhucexia.com/credits/"> 我的积分 </a> | <a
							href="http://www.zhucexia.com/voucher/"> 我的优惠信息 </a> | <a
							href="http://www.zhucexia.com/orders/"> 我的交易 </a> |
		...
		<div class="grbg">
			...
			<script src="${root }/static/js/plugins/plupload.full.min.js"></script>
			<style>
#facebox .content {
						...
						<div class="pc_tabs pc_tabs-full margin_b20 clearfix">
							<div class="tabGray">
								<div class="tabBox leftTab">
									<ul class="tabLinks">
										<li class="selected"><a
											href="${root }/static/助策侠网络科技有限公司 我的账户.html">账户总览</a></li>
									...
									<div class="pc_personInfo">
										<div class="pc_personInfobox clearfix">
											...
											<div class="pc_personInfo_body mb5">
												<div>
													<span class="userName"> 昵称：13501635413 <span
														class="black9"></span>
										...
										<div class="jygl clearfix">
											...
											<div class="bd">
												<dl>
													<dt>
														<a href="http://www.zhucexia.com/orders/"><img
															src="${root }/static/images/user/purchasemanagement.png"></a>
													</dt>
													<dd>
												...
												<dl>
													<dt>
														<a href="http://www.zhucexia.com/unreview/items/"><img
															src="${root }/static/images/user/remarkmanagement.png"></a>
													</dt>
													<dd>
												...
												<dl>
													<dt>
														<a href="http://www.zhucexia.com/favorites/"><img
															src="${root }/static/images/user/myfavorites.png"></a>
													</dt>
													<dd>
												...
												<dl>
													<dt>
														<a href="http://www.zhucexia.com/addressbook/"><img
															src="${root }/static/images/user/procurementlist.png"></a>
													</dt>
													<dd>
										...
										<div class="jygl clearfix">
											...
											<div class="mod_cutLine"></div>
											<div class="bd">
												<script src="${root }/static/js/plugins/facebox.js"></script>
												<script>
													$(document)
															.ready(
																	function() {
													...
													<div class="span4">
														<div class="box-quick-link blue-background">
															<a href="http://www.zhucexia.com/account/profile_edit/"
																rel="facebox"><div class="link-header">
																	<i class="fa fa-edit fa-2x"></i>
																</div>
																<div class="content-title">基本信息</div></a>
														</div>
													</div>
													<div class="span4">
														<div class="box-quick-link grass-green-background">
															<a
																href="http://www.zhucexia.com/account/password_change/"
																rel="facebox"><div class="link-header">
																	<i class="fa fa-lock fa-2x"></i>
																</div>
																<div class="content-title">修改密码</div></a>
														</div>
													</div>
													<div class="span4">
														<div class="box-quick-link muted-background">
															<a href="http://www.zhucexia.com/account/bind_mobile/"
																...
																<div class="content-title">绑定手机</div></a>
														</div>
													</div>
													<div class="span4">
														<div class="box-quick-link green-background">
															<a href="http://www.zhucexia.com/review_info_iframe/"
																...
																<div class="content-title">完善信息</div></a>
														</div>
													</div>
												</div>
												<style>
...
#facebox .close {
	opacity: 1;
									...
									<div class="">
										...
										<div class="mb20 clearfix">
											...
											<div class="mainColor mt3 fl">
												<p>
													<i class="listStyle-dot"></i><span class="mr10">邮箱验证：未验证</span><a
														rel="facebox" target="_blank" class="blue"
														href="http://www.zhucexia.com/account/email/">验证</a>
												</p>
												<p>
													<i class="listStyle-dot"></i><span class="mr10">邮箱通知：未开通</span>
												</p>
											</div>
										</div>
										<!--邮箱结束 -->
										<!--手机开始 -->
										<div class="mb20 clearfix">
											<div class="icon-accountMobile icon-accountMobile fl mr15"></div>
											<div class="mainColor mt3 fl">
												<p>
													<i class="listStyle-dot"></i><span class="mr10">手机验证：已验证
														13501635413</span>
												</p>
												<p>
													<i class="listStyle-dot"></i><span class="mr10">短信通知：已开通</span>
												</p>
											</div>
										</div>
									</div>
		...
		<div class="ufot">
			<div class="ufotcot">
				<div class="rr">
					Copyright 2015. All rights reserved.助策侠网络科技有限公司 版权所有<a
						rel="nofollow" href="http://www.miibeian.gov.cn/" target="_blank">沪ICP备15039897号-1</a>
					<!--<div class="t_r">技术支持:<a href="http://www.danlu.net"><em>担路网</em></a></div>-->
				</div>
				<div class="footmenu">
					<a title="首页" target="_blank" class="s1"
						href="http://www.zhucexia.com/">网站首页</a><a title="关于我们"
						target="_blank" rel="nofollow"
						href="http://www.zhucexia.com/about.html">关于我们</a><a title="联系方式"
						target="_blank" rel="nofollow"
						href="http://www.zhucexia.com/contact.html">联系方式</a>
				</div>
			</div>
	...
	<script src="${root }/static/js/common/da.js"></script>
	<div id="facebox" style="display: none;">
		<div class="popup">
			<div class="content"></div>
			<a href="http://www.zhucexia.com/home/#" class="close"><img
				src="${root }/static/images/user/closelabel.png" class="close_image" title="close"></a>
		</div>
	</div>
</body>
</html>
