		...
		<form class="theme-signin" name="editform" action="#" method="post"
			...
			<ul>
				...
				<li><strong>验 证 码：</strong> <input class="ipt" type="text"
					name="regmsg" size="20" id="getmess" style="width:100px;"/><span class="msgs" onclick="lostpwd()">获取短信验证码</span> <span class="yzms"></span>
				</li>
	...
	<div class="theme-popbod dform">
		<form class="theme-signin" name="editform" action="#" method="post"
			...
			<ul>
				...
				<li><center><span></span><input class="btn btn-primary" type="button" class="ipt" name="uppass"
					value=" 提  交  " class="bj" /> <input class="btn btn-primary" type="button" class="ipt" name="uppass"
